    ...
    return <>
      ...
      />
        <div className='flex h-10 bg-transparent absolute top-0 left-0'>
            <div className=' ml-16 mt-10 flex gap-x-96 justify-between ' >
                ...
                <Link href={"/emergency"}>
                <button className=" hover:cursor-pointer relative ml-20 inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 z-10">
